                    ...
                    ToolbarItem(placement: .topBarTrailing) {
                        if submitting {
                            ...
                            Button {
                                submitting = true
                                Task {
                                    try await ReportService.reportReply(user: user, replyUser: replyUser, reply: reply, harassment: harassment, violence: violence, scam: scam, impersonation: impersonation, slurs: slurs, other: other, additionalComments: additionalComments)
